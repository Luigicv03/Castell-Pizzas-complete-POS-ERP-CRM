                ...
                @if($is4Estaciones && count($baseIngredients) == 4)
                    ...
                    <div style="margin: 5px 0; display: flex; justify-content: center;">
                        <svg width="100" height="100" viewBox="0 0 100 100">
                            ...
                            <text x="50" y="25" text-anchor="middle" font-size="8" font-weight="bold" fill="#000">{{ $baseIngredients[0] ?? '' }}</text>
                            <text x="75" y="55" text-anchor="middle" font-size="8" font-weight="bold" fill="#000">{{ $baseIngredients[1] ?? '' }}</text>
                            <text x="50" y="80" text-anchor="middle" font-size="8" font-weight="bold" fill="#000">{{ $baseIngredients[2] ?? '' }}</text>
                            <text x="25" y="55" text-anchor="middle" font-size="8" font-weight="bold" fill="#000">{{ $baseIngredients[3] ?? '' }}</text>
                        </svg>
                    </div>
