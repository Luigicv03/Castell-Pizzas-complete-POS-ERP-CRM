...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $categories = [
            [
                'name' => 'Pizzas',
                'description' => 'Pizzas en diferentes tamaños',
                'color' => '#FF6B6B',
                'sort_order' => 1,
                'is_active' => true,
            ],
            [
                ...
                'description' => 'Ingredientes extra para pizzas',
                'color' => '#4ECDC4',
                'sort_order' => 2,
                'is_active' => true,
            ],
            [
                'name' => 'Cajas de Pizza',
                'description' => 'Cajas para delivery y takeaway',
                'color' => '#45B7D1',
                'sort_order' => 3,
                'is_active' => true,
            ],
            [
                'name' => 'Pastichos',
                'description' => 'Pastichos en diferentes tamaños',
                'color' => '#96CEB4',
                'sort_order' => 4,
                'is_active' => true,
            ],
        ...
        // Cargar Pizzas (ejemplo con algunas pizzas básicas)
        $pizzas = [
            // Pizzas Pequeñas (8")
            [
        ...
        $this->command->info('Productos cargados exitosamente:');
